...
def skill_manage(
    ...
    if action == "create":
        ...
        # SOUL gate: check if the active profile's SOUL.md forbids autonomous
        # skill creation. Each profile owns its own SOUL.md independently.
        # Applies to ALL origins, not just background-review fork.
        try:
            from hermes_constants import get_hermes_home
            _soul_path = get_hermes_home() / "SOUL.md"
            _soul_text = _soul_path.read_text(encoding="utf-8").lower()
