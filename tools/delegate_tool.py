...
# delegate_tool so the parent's tool names are never clobbered by another
...
def _build_top_level_description() -> str:
    ...
    return (
        ...
        "new message), an in-flight subagent is cancelled automatically.\n"
        "- Delegating coding tasks to Claude Code -> use terminal(background=True) "
        "or ask the user to start a dedicated session\n\n"
        "IMPORTANT:\n"
